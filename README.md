...
Some values used for the Gradle configuration shouldn't be stored in files to avoid publishing them
...
If your plugin provides complex user interfaces, you should consider covering them with tests and
